...
\resumeProjectHeading
      ...
      \resumeProjectHeading
          ...
          \resumeItemListStart
            \resumeItem{Developed 4 full-stack club/stealth startup websites with Gradle/Java backend, React frontend, and MongoDB.}
...
\section{Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     ...
     \textbf{Other Intersts: }{Automation, Computer Vision, Crypto, Web3, QA, cybersecurity, product management, UI/UX, Virtual/Augmented Reality, Cloud computing, app development}
    }}
 \end{itemize}
