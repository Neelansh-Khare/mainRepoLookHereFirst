    ...
    \resumeSubheading
      ...
      \begin{itemize}[leftmargin=0.15in, label={}]
        \small{\item{
         ...
         \textbf{Extracurriculars: }{Software Developer for Legacy Robotics, Event Coordinator for the Indian Subcontinent Club (ISC), Intern for ASUCI, Volunteer for ENGin, Philanthropy Chair for Sigma Pi, Fundraising Chair for UCI Fits
         }\\
        }}
        \end{itemize}
