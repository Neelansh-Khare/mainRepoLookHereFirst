    ...
    \resumeSubheading
      ...
      \begin{itemize}[leftmargin=0.15in, label={}]
        \small{\item{
         ...
         \textbf{Extracurriculars: }{Software Developer for ICSSC, President for the Indian Subcontinent Club, Google Developer Student Club, Volunteer for ENGin, Philanthropy Chair for Sigma Pi, Software Developer for Legacy Robotics
         }\\
        }}
        \end{itemize}
